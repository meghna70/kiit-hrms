    ...
    <div className='Forms' >
        <Stack spacing={50}>
          ...
          borderRadius: 'md',
                    ...
                    <Typography margin="normal" variant="h4" color='green'> Hospitality </Typography>
                    <FormControl margin="normal" fullWidth required>
                        ...
                        >
                            ...
                            <MenuItem value="Party Booking">Party Booking</MenuItem>
                        </Select>
                    </FormControl>

                    
                    <LocalizationProvider dateAdapter={AdapterDayjs}>
                    <DesktopDatePicker className="" label="Avail Date" inputFormat="YYYY-MM-DD" disableFuture value={valuetime} onChange={handleChangetime}
                     renderInput={(params) => <TextField sx={{mt:2,mb:1}} {...params} fullWidth />} />
                    </LocalizationProvider>


                    <TextField name="total_price" onChange={handleChange} type="text" label="Total Price" fullWidth value={inputs.total_price} margin="normal" required />
